...
class Client {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("List of available commands: Type \'EXIT\' to close the connection.");
            System.out.println("----------------------------------------------------------");
            ...
            System.out.println("|  6. REMOVE <username> <bookName>");
            System.out.println("|  7. GET_MY_BOOKS <username>");
            System.out.println("|  8. REQUEST <borrowerUsername> <lenderUsername> <bookId> <message>");
            System.out.println("|  9. ACCEPT <lenderName> <requestId>");
            System.out.println("|  10. REJECT <lenderName> <requestId>");
            System.out.println("|  11. REQUEST_HISTORY <username>");
            System.out.println("|  12. LIBRARY_STATS <username> SHOULD BE ADMIN");
